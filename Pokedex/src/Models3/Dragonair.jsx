...
export function Dragonair(props) {
  const { nodes, materials } = useGLTF("/Dragonair.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI, 0, Math.PI]} scale={0.083}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Dragonair_1.geometry}
          material={materials.Material__194}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Dragonair_2.geometry}
          material={materials.Material__195}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Dragonair_3.geometry}
          material={materials.Material__196}
        />
      </group>
