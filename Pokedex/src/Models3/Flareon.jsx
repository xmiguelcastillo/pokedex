...
export function Flareon(props) {
  const { nodes, materials } = useGLTF("/Flareon.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <skinnedMesh
        geometry={nodes.Flareon_1.geometry}
        material={materials["Material__10.004"]}
        skeleton={nodes.Flareon_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.Flareon_2.geometry}
        material={materials["Material__11.004"]}
        skeleton={nodes.Flareon_2.skeleton}
      />
      <skinnedMesh
        geometry={nodes.Flareon_3.geometry}
        material={materials["Material__12.002"]}
        skeleton={nodes.Flareon_3.skeleton}
      />
      <skinnedMesh
        geometry={nodes.Flareon_4.geometry}
        material={materials["Material__13.001"]}
        skeleton={nodes.Flareon_4.skeleton}
      />
    </group>
  );
}

useGLTF.preload("/Flareon.glb");
