...
export function Doduo(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI, 0, Math.PI]} scale={0.485}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.DoduoM_1.geometry}
          material={materials["Body.014"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.DoduoM_2.geometry}
          material={materials.EyeA}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.DoduoM_3.geometry}
          material={materials.BodyFur}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.DoduoM_4.geometry}
          material={materials.EyeB}
        />
      </group>
