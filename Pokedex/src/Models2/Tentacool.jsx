...
export function Tentacool(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI / 2, 0, Math.PI]} scale={0.738}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Tentacool_1.geometry}
          material={materials.BodyTattu00}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Tentacool_2.geometry}
          material={materials["Eye.028"]}
        />
      </group>
