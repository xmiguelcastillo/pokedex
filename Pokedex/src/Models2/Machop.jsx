...
export function Machop(props) {
  const { nodes, materials } = useGLTF(`${import.meta.env.BASE_URL}Machop.glb`);
  return (
    <group {...props} dispose={null}>
      ...
      <skinnedMesh
        geometry={nodes.Machop_1.geometry}
        material={materials.Material__76}
        skeleton={nodes.Machop_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.Machop_2.geometry}
        material={materials.Material__77}
        skeleton={nodes.Machop_2.skeleton}
      />
    </group>
  );
}

useGLTF.preload("/Machop.glb");
