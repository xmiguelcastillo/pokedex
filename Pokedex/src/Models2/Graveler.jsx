...
export function Graveler(props) {
  const { nodes, materials } = useGLTF("/Graveler.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI / 2, 0, Math.PI]} scale={0.775}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Graveler_1.geometry}
          material={materials["Eye.031"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Graveler_2.geometry}
          material={materials["BodyA00.004"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Graveler_3.geometry}
          material={materials.BodyB00}
        />
      </group>
