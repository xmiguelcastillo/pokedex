...
export function Shellder(props) {
  const { nodes, materials } = useGLTF("/Shellder.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pm0090_00_SkinShape_0_0_node.geometry}
        material={materials["BodySpc_mat_002.001"]}
        rotation={[Math.PI / 2, 0, Math.PI]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pm0090_00_SkinShape_1_0_node.geometry}
        material={materials["BodySpcVco_mat_002.001"]}
        rotation={[Math.PI / 2, 0, 0]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pm0090_00_SkinShape_2_0_node.geometry}
        material={materials["Body_mat_002.001"]}
        rotation={[Math.PI / 2, 0, Math.PI]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pm0090_00_SkinShape_3_0_node.geometry}
        material={materials["BodyVco_mat_002.001"]}
        rotation={[Math.PI / 2, 0, Math.PI]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pm0090_00_SkinShape_4_0_node.geometry}
        material={materials["Eye_mat_002.001"]}
        rotation={[Math.PI / 2, 0, Math.PI]}
      />
