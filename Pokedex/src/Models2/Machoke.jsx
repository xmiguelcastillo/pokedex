...
export function Machoke(props) {
  const { nodes, materials } = useGLTF("/Machoke.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <skinnedMesh
        geometry={nodes.Machoke_1.geometry}
        material={materials["Material__89.001"]}
        skeleton={nodes.Machoke_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.Machoke_2.geometry}
        material={materials["Material__90.001"]}
        skeleton={nodes.Machoke_2.skeleton}
      />
    </group>
  );
}

useGLTF.preload("/Machoke.glb");
