...
export function Poliwrath(props) {
  const { nodes, materials } = useGLTF("/Poliwrath.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI / 2, 0, Math.PI]} scale={0.438}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Poliwrath_1.geometry}
          material={materials["BodyNyorobon.003"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Poliwrath_2.geometry}
          material={materials["Eye.025"]}
        />
      </group>
