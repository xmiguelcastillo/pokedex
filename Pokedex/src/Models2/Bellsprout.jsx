...
export function Bellsprout(props) {
  const { nodes, materials } = useGLTF("/Bellsprout.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI / 2, 0, Math.PI]} scale={0.75}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Bellsprout_1.geometry}
          material={materials["Body00.007"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Bellsprout_2.geometry}
          material={materials["Eye.026"]}
        />
      </group>
...
useGLTF.preload("/Bellsprout.glb");
