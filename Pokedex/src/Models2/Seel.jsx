...
export function Seel(props) {
  const { nodes, materials } = useGLTF(`${import.meta.env.BASE_URL}Seel.glb`);
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI, 0, Math.PI]} scale={0.8}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Seel_1.geometry}
          material={materials["Body.016"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Seel_2.geometry}
          material={materials["Eye.036"]}
        />
      </group>
