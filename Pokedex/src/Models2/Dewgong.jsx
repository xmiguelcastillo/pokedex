...
export function Dewgong(props) {
  const { nodes, materials } = useGLTF("/Dewgong.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[Math.PI, 0, Math.PI]} scale={0.665}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Dewgong_1.geometry}
          material={materials["Body.017"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Dewgong_2.geometry}
          material={materials["Eye.037"]}
        />
      </group>
